...
<body>
	...
	<div id="col2" style="background-color:white;margin-top:20px;">
		<div id="title1" style = "background-color:black;margin-top:0px;">
...
?>
		...
		<div id="ripple">
<?
	    $sql = "select * from bowling_ripple where parent='$item_num'";
